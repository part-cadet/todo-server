...
const { authenticateUser, addUser, getUsers, removeUserAccount } = require('../controller/controller')
...
router.delete('/api/users', removeUserAccount)

router.get('/api/boards/allmembersof/:taskID', getAllMembersOfBoard)
